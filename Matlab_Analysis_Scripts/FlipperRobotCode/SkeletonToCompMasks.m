...
% All of this below is just testing what happens if we move how we define
% the gap compartment
% originalDilation = ones(9);
sizeOfVertDilation = 9;
sizeOfHorizDilation = 9;
testDil = zeros(sizeOfVertDilation);
testDil(:,((sizeOfVertDilation-sizeOfHorizDilation)/2+1):(sizeOfVertDilation+sizeOfHorizDilation)/2) = 1;
