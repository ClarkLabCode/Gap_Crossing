...
% the single input given was not a number
if nargin > 1
...
FindFramesForFlipFunc               = @FindFramesForFlip;
...
FlipBinnerFunc                      = @FlipBinner;
ZapStationaryFlipsFunc              = @ZapStationaryFlips;
...
while strcmp(SaveCheckpointResponse, contOpt)
    ...
    % Keep track of how long it actually takes to run the step(s)
    tic
    ...
    % Output to user how long it took for the step(s) completed
    toc
