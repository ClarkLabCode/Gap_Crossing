...
The `Data` directory represents the location in which the analysis code expects the downloaded data (available on [Dryad](https://doi.org/10.5061/dryad.kkwh70sgw)) to be saved.
