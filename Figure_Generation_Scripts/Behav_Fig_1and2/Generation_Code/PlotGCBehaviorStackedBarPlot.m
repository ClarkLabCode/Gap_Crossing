colorCross = [146,219,135]/255;
colorGlass = [27,133,184]/255;
colorCirc = [241,203,255]/255;
colorRet = [255,139,148]/255;
...
hold on
errorbar(1:0.5:2.5, AllGapEventFreqs(:,1),AllGapEventFreqsSEM(:,1),...
             'k','CapSize',0,'LineWidth',3,'Marker','o','MarkerSize',3,'MarkerFaceColor','auto','LineStyle','none');
plot(1:0.5:2.5,AllGapEventFreqs(:,1),'k')
hold off
ylim([0,1]);
xlim([0.8,2.7]);
xticks(1:0.5:2.5);
