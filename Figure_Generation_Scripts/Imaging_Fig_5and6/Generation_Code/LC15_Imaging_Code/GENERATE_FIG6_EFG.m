...
%% FIG6E: draw timeseries plots for rel. motion stims 
...
for bar40_idx = bar40_idxs
    ...
    PlotXvsY(curr_x_ax, curr_y_ax, 'error', curr_sem, 'color', [0.8500 0.3250 0.0980]);
...
for bar160_idx = bar160_idxs
    ...
    xline(1000, "--k");
    ylim(time_trace_y_bounds);
    PlotXvsY(curr_x_ax, curr_y_ax, 'error', curr_sem, 'color', [0.3010 0.7450 0.9330]);
...
%% FIG6F: plot mean resps wrt backg spd, bar Ftb bg Ftb
...
%% FIG6G  plot mean resps wrt ratio of spds, bar Ftb bg Ftb
